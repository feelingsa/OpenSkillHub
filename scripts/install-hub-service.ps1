...
New-Service -Name $ServiceName -BinaryPathName $binaryPath -DisplayName "OpenSkillHub" -Description "LAN-accessible OpenCode Skill platform" -StartupType Automatic
